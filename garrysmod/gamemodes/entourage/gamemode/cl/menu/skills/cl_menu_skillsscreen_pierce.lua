    ...
    timer.Simple( 0.5, function()
        ...
        local s_performance = vgui.Create( "DImageButton", skills_frame_pierce ) 
            ...
            s_performance.DoClick = function()
                ...
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
                sk_desc1:AppendText( 30 + 5 * plskills_a["s_performance"].Level .."% " )
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
                sk_desc1:AppendText( " of base weapon damage. Heal allies for " )
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
                sk_desc1:AppendText( 5 + 5 * plskills_a["s_performance"].Level )
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
                sk_desc1:AppendText( "+ 5% of their max HP. \n" )
                sk_desc1:AppendText( "\n" )
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
                sk_desc1:AppendText( "1 turn cooldown \n" )
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
        ...
        local s_heartcut = vgui.Create( "DImageButton", skills_frame_pierce )
            ...
            s_heartcut.DoClick = function()
                ...
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
                sk_desc1:AppendText( "Deal 75% base weapon damage to a single target with " )
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
                sk_desc1:AppendText( 15 + 5 * plskills_a["s_heartcut"].Level .."%" )
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
                sk_desc1:AppendText( "bonus crit chance and " )
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
                sk_desc1:AppendText( 10 + 5 * plskills_a["s_heartcut"].Level )
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
                sk_desc1:AppendText( " bonus crit damage. \n" )
                sk_desc1:AppendText( "\n" )
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
        ...
        local s_gouge = vgui.Create( "DImageButton", skills_frame_pierce )
            s_gouge:SetSize( 50, 50 )
            s_gouge:SetPos( 325, 460 - 25 + 12 )
            s_gouge:SetImage( "skills/entourage_s_gouge.png" )
            s_gouge.DoClick = function()
                skpic2_a = s_gouge:GetImage()
                skpic2:Show()

                aimed_skill2 = s_gouge
                ...
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
                sk_desc1:AppendText( 50 + 5 * plskills_a["s_gouge"].Level .."%" )
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
                sk_desc1:AppendText( " base weapon damage to one target; decrease its accuracy and increase your dodge chance by " )
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
                sk_desc1:AppendText( 15 + 3 * plskills_a["s_gouge"].Level )
                sk_desc1:AppendText( "\n\n" )
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
                sk_desc1:AppendText( "3 turn cooldown \n" )
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
                ...
                sk_desc1:AppendText( "Skill level: ")
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
                sk_desc1:AppendText( plskills_a["s_gouge"].Level )
                sk_desc1:InsertColorChange( 255, 255, 255, 255)
                sk_desc1:AppendText( "/10")

                FuckMyLife2()
            end
            if plskills_a["s_gouge"].equipped < 1 then
                s_gouge:SetColor( unavailable )
            end
        ...
        local s_tknives = vgui.Create( "DImageButton", skills_frame_pierce )
            ...
            s_tknives.DoClick = function()
                ...
                sk_desc1:InsertColorChange( plcol.x, plcol.y, plcol.z, 255 )
                sk_desc1:AppendText( 5 + plskills_a["s_tknives"].Level )
                sk_desc1:InsertColorChange( 255, 255, 255, 255 )
